<template>
	<view class="page19-wrap" @click="next">
		<!-- 心湖 旅行伙伴2 -->
	...
	export default {
		...
		methods: {
			next() {
				...
				// })
				this.$emit('pageEvent', {pageIndex: '20'})
			}
		}
	}
</script>
...
<style lang="scss">
	.page19-wrap {
		...
		background-image: url(https://datastream.affectai.cn/callmaterial/images/page20-1024/img9.png);
