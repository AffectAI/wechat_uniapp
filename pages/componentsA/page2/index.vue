<template>
	<view class="page122-wrap" @click="next">
		<!--  传闻，心灵之山的山顶有一份宝藏-->
		
		<view class="content">
			<view style="font-size: 18px;color: #fff;text-align: center;margin-bottom: 30px;">
			...
			<view style="font-size: 18px;color: #fff;text-align: center;">
				<typewriter
					v-if="setc"
					text="攀登心灵之山，寻觅宝藏吧！"
					:speed="100"
...
<script>
	...
	export default {
		...
		methods: {
			...
			next() {
				if(this.isNext) {
					this.$emit('pageEvent', {pageIndex: 3})
				}
			},
			finished1() {
				this.seta = true
