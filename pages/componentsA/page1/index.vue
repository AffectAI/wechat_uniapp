      ...
      <view class="privacy-wrap">
        ...
        <view style="padding: 0 23px; margin-top: 42px">
          <view style="margin-top: 11px; font-size: 16px">
            1.本次测试共包含4份科学性的量表问卷以及几项相应的游戏化测评项目。
          </view>
          <view style="margin-top: 11px; font-size: 16px"
            >2.测评过程中需全程开启摄像头和麦克风，以方便我们获取您的情绪及面部数据。摄像头不可自行关闭，为保证测评结果的准确性，请注意正对摄像头，测评过程中请勿离开摄像区域。
          </view>
          <view style="margin-top: 11px; font-size: 16px"
            >3.所有测试项目将用于最终生成您的专属心理测评报告。
          </view>
        </view>
        ...
        <view style="padding: 0 23px; margin-top: 30%">
          ...
          >
            <view @click="readYs">
              <text
                style="color: #07c160; text-decoration: underline"
      ...
      <view class="privacy-content" v-if="priacyContent">
        <view style="padding: 23px">
          ...
          <view class="font14" style="margin: 7px 0">
            情感识别科技有限公司心理健康评测软件隐私政策
          </view>
          <view class="font14">更新日期：2024年1月29日</view>
          <view class="font14">生效日期：2024年1月29日</view>
          <view class="font15" style="margin-top: 22px">
            <view style="margin-bottom: 10px">
              本《情感识别科技有限公司心理健康评测软件隐私政策》（“《隐私政策》”）适用于安徽情感识别科技有限公司（“情感识别”或“我们”）发布的“情感识别科技有限公司心理健康评测软件”应用程序（“情感识别科技有限公司心理健康评测软件”）以及与之相关的服务（合称“情感识别科技有限公司心理健康评测软件服务”）。
            </view>

            <view style="margin-bottom: 10px">
              本隐私政策旨在向您解释，在您访问或使用我们的情感识别科技有限公司心理健康评测软件服务期间，我们将会如何收集、存储、使用、处理、披露、共享、传输和保护您的个人信息及数据（以下称“个人信息”）以及与之有关的事项。
            </view>
            ...
            <view class="font16a">定义和解释</view>
            <view style="margin-bottom: 10px">
              “个人信息”指以电子或者其他方式记录的能够单独或者与其他信息结合识别自然人个人身份的各种信息。
            </view>

            <view style="margin-bottom: 10px">
              “个人敏感信息”指一旦泄露、非法提供或滥用可能危害人身和财产安全，极易导致个人名誉、身心健康受到损害或歧视性待遇的个人信息。个人敏感信息包括但不限于身份证件号码、个人生物识别信息、银行账号、通信内容、健康生理信息。
            </view>
            ...
            <view class="font16a">我们如何收集和使用您的个人信息</view>
            <view style="margin-bottom: 10px">
              为向您提供情感识别科技有限公司心理健康评测软件服务，我们将在法律允许的范围内收集您的个人信息。如果您不提供相关个人信息，可能无法享受我们提供的情感识别科技有限公司心理健康评测软件服务或其某些功能，或者无法达到我们提供的情感识别科技有限公司心理健康评测软件服务的预期效果。
            </view>

            <view style="margin-bottom: 10px">
              我们将遵循合法、正当、必要的原则，仅将您主动提供的个人信息和我们主动收集的个人信息用于本《隐私政策》所限定的使用用途并与实现情感识别科技有限公司心理健康评测软件服务的业务功能有直接关联，以为您提供情感识别科技有限公司心理健康评测软件服务，并用于身份验证、安全防范、防止欺诈和滥用、响应法律请求、存档备份、改善和加强我们的情感识别科技有限公司心理健康评测软件服务、排除故障和防止错误、进行数据分析和测试、客户的安全服务以提高情感识别科技有限公司心理健康评测软件服务的安全性。
            </view>
            <view style="margin-bottom: 10px">
              具体而言，在您访问、使用我们的情感识别科技有限公司心理健康评测软件服务和/或我们向您提供情感识别科技有限公司心理健康评测软件服务的过程中，我们将在下述情形中收集和使用以下各类信息。
            </view>
            <view class="font16a">登录</view>
            <view style="margin-bottom: 10px">
            ...
            <view class="font16a">情感健康分析</view>
            <view style="margin-bottom: 10px">
            ...
            <view style="margin-bottom: 10px">
              ...
              和法律法规规定的其他情形。<br />
              <view class="font16a">补充说明</view><br />
            ...
            <view style="margin-bottom: 10px">
              ...
              <view class="font16a">公开披露</view><br />
            ...
            <view style="margin-bottom: 10px">
              <view class="font16a">我们如何存储和保护您的个人信息</view><br />
              我们如何存储您的个人信息<br />
            ...
            <view style="margin-bottom: 10px">
              <view class="font16a">信息出境</view><br />
            ...
            <view style="margin-bottom: 10px">
              <view class="font16a">我们如何保护您的个人信息</view><br />
            ...
            <view style="margin-bottom: 10px">
              <view class="font16a">回复您的请求</view><br />
