<template>
	<view class="page1-wrap">
		...
		<view class="tips"> <u-image src="https://dfs.affectai.cn/affect-material/images/page5/icon1.png" width="12px" height="11px" style="margin-right: 4px;"></u-image> 请将人脸置于屏幕之内，并确保面部完整显示</view>
