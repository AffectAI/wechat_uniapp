<template>
  <view class="page30-wrap">
    ...
    <view
      class="brid"
      v-show="!isOut"
      :style="{ bottom: bridBottom + 'px', left: bridLeft + 'px' }"
    ></view>
    ...
    <view
      class="outBrid"
      v-show="isOut"
      :style="{ bottom: outBottom + 'px', left: bridLeft + 'px' }"
    ></view>
    ...
    >
      ...
      ></u-image>
      <u-image
        src="https://dfs.affectai.cn/affect-material/images/page23/img9.png"
        width="225px"
        height="55px"
        style="
          width: 225px;
...
export default {
  data() {
    return {
      start_game_img: require("../../../static/uview/example/img12.png"),
      end_game_img: require("../../../static/uview/example/img3.png"),
      yun_img8: require("../../../static/uview/example/img8.png"),
  ...
  mounted() {
    ...
    this.innerAudioContext.src =
      "https://dfs.affectai.cn/affect-material/images/audio/a4.mp3";
  },
  beforeDestroy() {
    if (this.time) {
