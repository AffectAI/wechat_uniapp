<template>
	<view class="page1-wrap" @click="next">
		<!-- 心湖- 流程图1 -->
		<view class="img11"></view>
		<view class="img21"></view>
	...
	export default {
		...
		methods: {
			next() {
				...
				// })
				this.$emit('pageEvent', {pageIndex: 11})
			}
		}
	}
</script>
...
<style lang="scss">
	.page1-wrap {
		...
		.img11 {
			...
			height: 180px;
			margin: 0 auto;
			background-image: url(https://datastream.affectai.cn/callmaterial/images/page7/map.png);
			background-position: center;
			background-size: 100%;
			background-repeat: no-repeat;
		}
