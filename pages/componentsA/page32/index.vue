<template>
	<view class="page32-wrap" @click="next">
		<view class="models32">
			<view style="background-color: #f3dc98;width: 100%;margin: 2px auto 20px auto;padding: 7px;border-radius: 5px;"> {{liuyanTxt}} </view>
		...
		<view v-if="timeCount >= 20" @click="endSound" style="width: 80px;text-align: center;line-height: 45px;line-height: 45px;font-size: 17px;border-radius: 5px;background-color: #58a5f3;position: absolute;right: 0;left: 0;margin: auto;bottom: 25%;">完成</view>
	...
	export default {
		...
		mounted() {
			...
			this.ctx.onStop( (res) => {
				...
				this.$emit('setRecore', {recoreTempPath: res.tempFilePath, audioType: 'happly_share'});
